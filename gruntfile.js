module.exports = function (grunt) {
      ...
      build: {
        files: [
          ...
          },
          {
            ...
            cwd: './src/app/mailer/templates', // set working folder / root to copy
            src: '**/*', // copy all files and subfolders
            dest: 'dist/app/mailer/templates' // destination folder
          }
        ],
      },
    },
  ...
  grunt.registerTask("build", ["ts", "copy", "yaml"]);
};
